...
\par Zastosowanie w/w mechanizmu jest podane w Listingu \ref{lst:tagsPickerJs}. Poprzez \verb|Tags.query(callback)| odpytujemy serwer o listę wszystkich tagów na serwerze. Poprzez utworzenie nowej instancji tworzymy nowy tag, a wywołując na nim metodę \verb|.$save(callback)| zapisujemy go na serwerze.
