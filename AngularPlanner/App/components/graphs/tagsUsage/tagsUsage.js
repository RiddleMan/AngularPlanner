...
* Tags usage graph
*/
angular.module('graphs.tagsUsage', ['highcharts-ng']).factory('TagsUsageData', [
  '$http',
  '$q',
  function ($http, $q) {
    var defer = $q.defer();
  ...
  'TagsUsageData',
  '$location',
  function ($scope, TagsUsageData, $location) {
    ...
    (function init() {
      ...
      $scope.options = {
        options: {
          ...
          title: { text: 'Statystyki korzystania z tagowania' },
